...
async function phase4IngestCampaigns(client) {
  ...
  // Helper to map campaign titles/garment types to high-res transparent mockups
  const getMockupImage = (title, type) => {
    const t = (title || "").toLowerCase();
    const isTee = (type || "").toLowerCase().includes("tee") || (type || "").toLowerCase().includes("t-shirt");
    
    if (t.includes("asshole")) {
      return isTee ? "/products/product-12-668a76b5-nobg.png" : "/products/product-01-68e548fa-nobg.png";
    }
    if (t.includes("wild")) {
      return "/products/product-04-68e2b219-nobg.png";
    }
    if (t.includes("alzheimer") || t.includes("senility") || t.includes("forgot")) {
      return "/products/product-06-68d2df41-nobg.png";
    }
    if (t.includes("rider") || t.includes("still-burning")) {
      return "/products/product-07-68d2d14a-nobg.png";
    }
    if (t.includes("respect")) {
      return "/products/product-08-68ceb440-nobg.png";
    }
    if (t.includes("biker") || t.includes("bikers") || t.includes("old bikers")) {
      return "/products/product-10-668a76c6-nobg.png";
    }
    if (t.includes("arthritis")) {
      if (t.includes("retro")) {
        return isTee ? "/products/product-09-66c0d3a0-nobg.png" : "/products/product-05-68d2e58e-nobg.png";
      }
      if (t.includes("togc")) {
        return isTee ? "/products/product-11-668a76cd-nobg.png" : "/products/product-03-68e4510b-nobg.png";
      }
      return "/products/product-02-68e5477a-nobg.png";
    }
    
    // Fallback based on title hash so that all campaigns have unique mockups
    const fallbackImages = [
      "/products/product-01-68e548fa-nobg.png",
      "/products/product-02-68e5477a-nobg.png",
      "/products/product-03-68e4510b-nobg.png",
      "/products/product-04-68e2b219-nobg.png",
      "/products/product-05-68d2e58e-nobg.png",
      "/products/product-06-68d2df41-nobg.png",
      "/products/product-07-68d2d14a-nobg.png",
      "/products/product-08-68ceb440-nobg.png",
      "/products/product-09-66c0d3a0-nobg.png",
      "/products/product-10-668a76c6-nobg.png",
      "/products/product-11-668a76cd-nobg.png",
      "/products/product-12-668a76b5-nobg.png"
    ];
    let hash = 0;
  ...
  for (const campaign of campaignsData) {
    ...
    campaign.details.items.forEach(subItem => {
      ...
      if (product.images.length === 0) {
        let imgSrc = getMockupImage(campaignTitle, subItem.type);
        product.images.push({
          id: `img-${product.id}`,
          src: imgSrc,
        ...
        subItem.variants.colors.forEach(colorObj => {
          subItem.variants.sizes.forEach(size => {
            product.variants.push({
              ...
              price: stylePrice,
              inStock: true,
              imageUrl: getMockupImage(campaignTitle, subItem.type),
    ...
    if (product.variants.length === 0) {
      product.variants.push({
        ...
        price: product.price,
        inStock: true,
        imageUrl: getMockupImage(campaignTitle, "Default"),
